class SystemsController < ApplicationController
  ...
  private
    ...
    def system_params
      params.require(:system).permit(:room_id, :build_date, :system_type, :system_dimensions, :levels, :lights, :notes, :system_name, :retired, :flat_slots, :retired_on, :pumps, :pump_time)
    end
end
